...
**Mission Briefing:**
CryptKeepers operatives have been exchanging secret messages through internal HTTP servers. You have discovered five active API endpoints on the local network. While they all serve generic web pages, our intelligence suggests that ONE of them is transmitting the agency flag in a covert channel.
...
* `http://localhost:5000/covert/channel_1`
* `http://localhost:5000/covert/channel_2`
* `http://localhost:5000/covert/channel_3`
* `http://localhost:5000/covert/channel_4`
* `http://localhost:5000/covert/channel_5`

---

## 🛠️ Tools & Techniques

Since these are live web addresses, use the pre-installed terminal tools to perform an HTTP HEAD request:
...
| **Browser DevTools** | Press F12 in a browser and check the "Network" tab to see header traffic. | N/A |
