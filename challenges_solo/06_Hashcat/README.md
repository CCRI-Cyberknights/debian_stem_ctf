...
**Mission Briefing:**
You have intercepted 3 encrypted archive segments from a data exfiltration attempt. Each segment (`part1.zip`, `part2.zip`, `part3.zip`) is locked with a different password. However, we also found a file (`hashes.txt`) containing the MD5 hashes of those passwords.
...
This challenge requires a pipeline of tools to reconstruct the data.
...
| **4. Assemble** | **cat** | `cat fragment1 fragment2 fragment3 > flag.txt` |
