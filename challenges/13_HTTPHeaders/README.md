...
**Mission Briefing:**
CryptKeeper operatives have been exchanging secret messages through internal HTTP servers. You have discovered five active API endpoints on the local network, but only ONE contains the real agency flag.
...
* **The Strategy:** Interrogate the endpoints to inspect the metadata transmitted by the server.
