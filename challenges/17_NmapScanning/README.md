# 🛰️ Challenge 17: Nmap Port Scanner
...
## 🧠 Intelligence Report
* **The Concept:** Before attacking a server, hackers use **Port Scanners** to knock on every "door" (port) to see which ones are open.
* **The Tool:** `nmap` (Network Mapper) is the industry standard for network discovery.
